...
<h1 class="page-header">
	...
	<span class="pull-right"> 
		<button class="btn btn-default" onClick="$('#add_customer_container').slideDown('fast');"><i class="fa fa-plus"></i> Add Customer</button>
	</span>
</h1>

<div class="col-lg-12" style="margin-top:25pt; display:none;" id="add_customer_container">
    <div class="panel panel-default"> 
        ...
        <div class="panel-body">
			<form role="form" action='customer_add.php' method='POST'>
				...
				<button class="btn btn-default" type="button" onClick="$('#add_customer_container').slideUp('fast');">Cancel</button>
...
<table class="table table-striped table-bordered table-hover dataTable no-footer" id="dt-customers">
	<thead>
		<tr>
