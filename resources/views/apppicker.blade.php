            ...
            <div class="col-lg-4 col-md-4 offset-md-2 offset-lg-0">
                <div class="card" style="background-color: #1BC98E;color: #252830 !important;">
                    <div class="card-block">
                        ...
                        <a href="accounts" class="btn btn-outline-pink" style="color: white !important; border-color: white !important;">Start</a>
                    </div>
                </div>
            </div>

            <div class="col-lg-4 col-md-4 offset-md-2 offset-lg-0">
                <div class="card" style="background-color: #E64759;color: #252830 !important;">
                    <div class="card-block">
                        <h4 class="card-title">MedSitter</h4>
                        <p class="card-text">This is our patient observation application.</p>
                        <a href="accounts" class="btn btn-outline-blue" style="color: white !important; border-color: white !important;">Start</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 offset-md-2 offset-lg-0">
                <div class="card" style="background-color: #9F86FF;color: #252830 !important;">
                    <div class="card-block">
                        <h4 class="card-title">MedSitter</h4>
                        <p class="card-text">This is our patient observation application.</p>
                        <a href="accounts" class="btn btn-outline-teal" style="color: white !important; border-color: white !important;">Start</a>
                    </div>
                </div>
            </div>
        </div>
