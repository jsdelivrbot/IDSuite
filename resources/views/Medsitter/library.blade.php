                        ...
                        <div class="row">
                            <div class="col-lg-1 align-self-center">
                                ...
                                @if(count($pod->getActiveParticipants()) < 4)
                                    <a id="pod-link-{{$pod->id}}" class="btn btn-outline-teal" href="/medsitter/patient/{{$pod->id}}-{{count($pod->getActiveParticipants())+1}}" role="button">Patient</a>
                                @else
                                    <a id="pod-link-{{$pod->id}}" class="btn btn-outline-teal disabled" href="/medsitter/patient/{{$pod->id}}-{{count($pod->getActiveParticipants())+1}}" role="button">Patient</a>
                                @endif
