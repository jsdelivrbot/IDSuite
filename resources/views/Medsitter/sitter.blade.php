                ...
                <div class="card-block">
                    ...
                    <div id="patient-connect-buttons-0" class="form-group">
                        <div class="input-group justify-content-center">
                            <button id="join-sms-0" title="Join SMS" class="toolbarButton joinsms" onclick="showSmsInput(0)"></button>
                        </div>
                    </div>

                    <div id="patient-connect-form-0" class="form-group d-none">
                        <div class="input-group justify-content-center">
                                <input type="tel" class="form-control" id="sms-join-number-0" aria-describedby="Phone Number" placeholder="Enter 10 digit number...">
                            <button id="join-sms-0" title="Join SMS" class="toolbarButton joinsms"></button>
                        </div>
                    </div>
            ...
            <div class="card" style="background-color: #434857 !important">
                ...
                <div class="card-block">
                    ...
                    <div id="patient-connect-buttons-1" class="form-group">
                        <div class="input-group justify-content-center">
                            <button id="join-sms-1" title="Join SMS" class="toolbarButton joinsms" onclick="showSmsInput(1)"></button>
                        </div>
                    </div>

                    <div id="patient-connect-form-1" class="form-group d-none">
                        <div class="input-group justify-content-center">
                            <input type="tel" class="form-control" id="sms-join-number-1" aria-describedby="Phone Number" placeholder="Enter 10 digit number...">
                            <button id="join-sms-1" title="Join SMS" class="toolbarButton joinsms"></button>
                        </div>
                    </div>
            ...
            <div class="card" style="background-color: #434857 !important">
                ...
                <div class="card-block">
                    ...
                    <div id="patient-connect-buttons-2" class="form-group">
                        <div class="input-group justify-content-center">
                            <button id="join-sms-2" title="Join SMS" class="toolbarButton joinsms" onclick="showSmsInput(2)"></button>
                        </div>
                    </div>

                    <div id="patient-connect-form-2" class="form-group d-none">
                        <div class="input-group justify-content-center">
                            <input type="tel" class="form-control" id="sms-join-number-2" aria-describedby="Phone Number" placeholder="Enter 10 digit number...">
                            <button id="join-sms-2" title="Join SMS" class="toolbarButton joinsms"></button>
                        </div>
                    </div>
            ...
            <div class="card" style="background-color: #434857 !important">
                ...
                <div class="card-block">
                    ...
                    <div id="patient-connect-buttons-3" class="form-group">
                        <div class="input-group justify-content-center">
                            <button id="join-sms-3" title="Join SMS" class="toolbarButton joinsms" onclick="showSmsInput(3)"></button>
                        </div>
                    </div>

                    <div id="patient-connect-form-3" class="form-group d-none">
                        <div class="input-group justify-content-center">
                            <input type="tel" class="form-control" id="sms-join-number-3" aria-describedby="Phone Number" placeholder="Enter 10 digit number...">
                            <button id="join-sms-3" title="Join SMS" class="toolbarButton joinsms"></button>
                        </div>
                    </div>
...
//                $('#patient-' + key).append('<div><span>Id: '+p.id+'</span></div><div><span>Name: '+p.first_name +' '+ p.last_name +'</span></div><div><span>Type: '+type+'</span></div><div><span>Muted: '+muted+'</span></div>');
                ...
                $('#patient-connect-form-' + key).addClass("d-none");
    ...
    <script type="text/javascript">
        ...
        function showSmsInput(id){
            ...
            $('#patient-connect-form-' + id).removeClass('d-none');
        }
